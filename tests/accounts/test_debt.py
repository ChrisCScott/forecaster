...
class TestDebtMethods(unittest.TestCase):
    ...
    def test_init_default(self):
        ...
        account = self.AccountType(
            self.owner)
        self.assertEqual(account.minimum_payment, Decimal(0))
        self.assertEqual(account.accelerated_payment, Decimal('Infinity'))
    ...
    def test_init_convert(self, *args, **kwargs):
        ...
        self.assertEqual(account.minimum_payment, minimum_payment)
        self.assertEqual(
            account.accelerated_payment, Decimal(accelerated_payment))
    ...
    def test_max_inflows_large_balance(self):
        ...
        self.assertAlmostEqual(balance, Decimal(0))
    ...
    def test_max_inflows_small_inflow(self):
        ...
        target = (
            ...
            - Decimal(60))  # Amount already added
    ...
    def test_max_inflows_large_inflow(self):
        ...
        result = self.debt.max_inflows(self.timing)
        target = Decimal(0)  # We can't add any more
