...
class TestSubForecast(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.account1 = Account(
            owner=self.person, balance=100, rate=1, nper=1)
    ...
    def setUp_decimal(self):
        ...
        self.subforecast = SubForecast(
            self.initial_year, high_precision=Decimal)
        self.person = Person(
            initial_year=self.initial_year,
            name="Test",
            birth_date="1 January 1980",
        ...
        self.available_acct = Account(
            initial_year=self.initial_year, rate=0, high_precision=Decimal)
    ...
    def test_transaction_delay(self):
        ...
        target = {
            self.available_acct: {0.5: -100},
            self.account2: {0.5: 100}}
    ...
    def test_add_trans_basic(self):
        ...
        self.assertEqual(
            self.available_dict[0],
            0)
        # A $100 transaction should be added to the account:
        self.assertEqual(
            self.account1.transactions[0],
            100)
    ...
    def test_add_trans_basic_acct(self):
        ...
        self.assertEqual(
            self.available_acct.transactions[0],
            0)
        # A $100 transaction should be added to account2:
        self.assertEqual(
            self.account2.transactions[0],
            100)
    ...
    def test_add_trans_delay(self):
        ...
        self.assertEqual(
            self.available_dict[0.5],
            0)
        # A $100 transaction should be added to account2:
        self.assertEqual(
            self.account2.transactions[0.5],
            100)
    ...
    def test_add_trans_delay_acct(self):
        ...
        self.assertEqual(
            self.available_acct.transactions[0.5],
            0)
        # A $100 transaction should be added to account2:
        self.assertEqual(
            self.account2.transactions[0.5],
    ...
    def test_add_trans_future_neg(self):
        ...
        self.assertEqual(
            self.available_dict[1],
            -50)
        # A $100 transaction should be added to account2:
        self.assertEqual(
            self.account2.transactions[1],
            100)
    ...
    def test_add_trans_acct_growth_btwn(self):
        ...
        self.assertEqual(
            (
                self.account1.transactions[0],
                self.account1.transactions[0.5]),
            (100, -150))
        # A $150 transaction should be added to account2:
        self.assertEqual(
            self.account2.transactions[0.5],
    ...
    def test_decimal(self):
        ...
        # Move all $100 to account1 right away:
        self.subforecast.add_transaction(
            value=Decimal(100), timing='start',
            from_account=self.available_dict, to_account=self.account1)
        # Transactions should be recorded against both available_dict
        # and account1:
        self.assertEqual(
